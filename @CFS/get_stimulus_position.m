...
% Possible positions are: UpperLeft, Top, UpperRight, Left, Center, Right, 
% LowerLeft, Bottom, LowerRight. 
% The size argument represents filling of the screen from 0 to 1, 
% e.g. 1 will fill 100% of the allocated window space.
%
