function time_elapsed = run_the_experiment(obj)
            %run_the_experiment(obj) Summary of this method goes here
            ...
            Screen('DrawTexture', obj.window, obj.textures{1}, [], obj.masks_rect, 0, 1, obj.mask_transparency);
            ...
            for mask = 2:obj.masks_number_before_target
                Screen('DrawTexture', obj.window, obj.textures{mask}, [], obj.masks_rect, 0, 1, obj.mask_transparency);
            ...
            for n = 1:obj.masks_number_while_fade_in*obj.waitframe
                ...
                thisContrast = n/(obj.masks_number_while_fade_in*obj.waitframe)*obj.target_transparency;
            ...
            for mask = obj.masks_number_before_target + obj.masks_number_while_fade_in + 1:obj.masks_number
                Screen('DrawTexture', obj.window, target, [], obj.target_rect, obj.target_rotation, 1, obj.target_transparency);
                Screen('DrawTexture', obj.window, obj.textures{mask}, [], obj.masks_rect, 0, 1, obj.mask_transparency);
                vbl = Screen('Flip', obj.window, vbl + (obj.waitframe - 0.5) * obj.inter_frame_interval);
            end
            vbl = Screen('Flip', obj.window, vbl + (obj.waitframe - 0.5) * obj.inter_frame_interval);
