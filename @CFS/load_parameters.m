...
%load_parameters Loads trial parameters provided in trial matrix.
    ...
    if obj.left_suppression==true
        ...
        obj.masks_rect = CFS.get_rect(obj.left_side_screen, ...
            obj.checker_rect_width, ...
            obj.mask_position, ...
            obj.mask_size, ...
            obj.left_screen_x_pixels/obj.left_screen_y_pixels);
    else
        obj.stimulus_rect = obj.stimulus_left_rect;
        obj.masks_rect = CFS.get_rect(obj.right_side_screen, ...
            obj.checker_rect_width, ...
            obj.mask_position, ...
            obj.mask_size, ...
            obj.right_screen_x_pixels/obj.right_screen_y_pixels);
    end
