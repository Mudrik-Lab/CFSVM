...
% See also CFS.Element.Stimulus.Masks.load_flashing_parameters 
    ...
    for frame = (start+1):stop
        with_stimulus(obj, ...
            obj.stimulus.indices(frame+1-start), ...
    ...
    if obj.stimulus.fade_in_duration ~= 0
        with_stimulus(obj, ...
            obj.stimulus.indices(stimulus_frame+1), ...
    ...
    for frame = (start+1):stop
        with_stimulus(obj, ...
            obj.stimulus.indices(stimulus_frame+frame+1-start), ...
            obj.masks.indices(frame), ...
            obj.stimulus.contrasts_in(end), ...
...
function with_stimulus(obj, stimulus_index, mask_index, contrast, rot_index)

    % Stimulus
    Screen('DrawTexture', ...
        obj.screen.window, ...
        obj.stimulus.textures.PTB_indices{stimulus_index}, ...
        [], ...
        obj.stimulus.rect, ...
